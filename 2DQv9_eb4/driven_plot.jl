...
function driven_plot(
    ...
    ax = Axis(
        ...
        ylabel = "|S[1][1]| (dB)",
        yautolimitmargin = (0.15f0, 0.05f0),
        kwargs...,
    )
...
output_path = joinpath(
    ...
    "driven",
    "lumped_3.83-3.93_Step0.0001_2024-10-11T151550",
)
driven_plot(
    output_path;
    show_arg = false,
...
output_path = joinpath(
    "/data/lesnow/2DQv8_eb4_data",
    "driven",
    "lumped_4.35-4.45_Step0.0001_2024-10-11T132010",
)
driven_plot(
    output_path;
    xlim = (4.37, 4.45),
...
output_path = joinpath(
    "/data/lesnow/2DQv8_eb4_data",
    "driven",
    "lumped_6.9-7.8_Step0.001_2024-10-11T103611",
)
