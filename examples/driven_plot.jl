...
function driven_plot(
    ...
    if save_filename == ""
        ...
        save(joinpath(save_path, splitpath(path)[end] * ".svg"), f)
    else
...
result_path = joinpath(
    ...
    "readout_resonator",
    "lumped_7.24-7.34_Step0.0001_2025-05-08T231111",
)
driven_plot(result_path)
...
driven_plot(result_path; show_arg=false, xlim=(3.87, 3.9), ref_data=[3.88017])
...
driven_plot(result_path; xlim=(4.38, 4.41), show_arg=false, ref_data=[4.38893])

result_path = joinpath(
    "/data/lesnow/2DQv8_eb4_data",
    "driven",
    "lumped_7.0-7.8_Step0.001_2025-04-03T024135",
)
